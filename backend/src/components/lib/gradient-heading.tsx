...
const headingVariants = cva(
  "tracking-tight pb-3 bg-clip-text text-transparent",
  {
    variants: {
      variant: {
        default:
          "text-black dark:text-transparent dark:bg-gradient-to-t dark:from-neutral-700 dark:to-neutral-200",
        pink: "bg-gradient-to-t from-accent to-accent/90 dark:to-neutral-200",
